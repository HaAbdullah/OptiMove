   ...
   useEffect(() => {
    ...
    return (
        ...
        <div className="spline-container">
            <Spline scene="https://prod.spline.design/yKqXYNzky1AIJ9Kq/scene.splinecode" onLoad={onLoad}/>
        </div>
        <div className="overlay">
            <h1 ref={titleRef} className={`${animate ? 'slideup' : "" }`}> OptiMove</h1>
        </div>
        <div className={`attach-img ${animate ? 'slideup' : "" }`} onClick={handleClick}>
            <img src="/attach.svg" alt = "Button to Attach Image"></img>
        </div>
        </div>
    );
};
